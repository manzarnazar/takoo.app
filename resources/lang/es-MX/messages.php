...
Smartly or Earn. ',
  ...
  'React_hero_slider_updated_successfully' => 'Imagen del slider principal actualizada correctamente',
  'React_hero_slider_deleted_successfully' => 'Imagen del slider principal eliminada correctamente',
  'React_hero_slider_added_successfully' => 'Imagen del slider principal agregada correctamente',
  'React_hero_slider_status_updated' => 'Estado del slider principal actualizado',
  'delete_react_hero_slider' => 'Eliminar slider principal',
  'Hero Slider' => 'Slider principal',
  'Hero Slider Section' => 'Sección de slider principal',
  'Show Hero Slider Section' => 'Mostrar sección de slider principal',
  'Add Hero Slider Image' => 'Agregar imagen al slider principal',
  'Upload Hero Slider Image' => 'Subir imagen del slider principal',
  'Upload your Hero Slider Image' => 'Sube la imagen de tu slider principal',
  'Hero Slider List' => 'Lista del slider principal',
  'Hero_Slider' => 'Slider principal',
  'Want_to_Delete_this_Hero_Slider' => '¿Desea eliminar este slide del slider principal?',
  'If_yes,_the_slide_will_be_removed_from_this_list' => 'Si acepta, el slide se eliminará de esta lista',
  'Update Hero Slider Image' => 'Actualizar imagen del slider principal',
  'See how your Hero Slider Section will look to customers.' => 'Vea cómo se verá la sección del slider principal para los clientes.',
  'Upload and manage full-width hero slider images for the landing page.' => 'Suba y administre imágenes de ancho completo para el slider principal de la página de inicio.',
  '(5:4)' => '(5:4)',
